...
import {View, Button, Dimensions, Text, ScrollView,StyleSheet,Image} from 'react-native';
...
const Dashboard = () => {
  ...
  return (
    <View  style={{padding: 20,backgroundColor:"white"}}>
      ...
      <Image source={require("../images/img3.png")} style={{width:window_width-20,height:200}}/>
      <View style={{flexDirection:"column"}}>
      <View style={{flexDirection:"row"}} >
        <View style={[styles.card,{ alignItems: 'center',backgroundColor:"#FFEFD8"}]}>
          <Text style={styles.cardTitle}>Total cases</Text>
          <Text style={styles.cardNumber}>
            {india.TotalConfirmed}
          </Text>
        </View>
        <View style={[styles.card,{padding: 80, alignItems: 'center',backgroundColor:"#CEC8E4"}]}>
